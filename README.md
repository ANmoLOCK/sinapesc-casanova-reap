...
| Versão atual | [**v1.7.29**](https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/tag/v1.7.29) |
...
## Download do EXE (v1.7.29)

**Link direto (ZIP):**

https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/download/v1.7.29/SinapescREAP-Windows-v1.7.29.zip

Página da release: https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/tag/v1.7.29

Versão anterior: [v1.7.28](https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/tag/v1.7.28)
