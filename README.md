...
| Versão atual | [**v1.7.28**](https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/tag/v1.7.28) |
...
## Download do EXE (v1.7.28)

**Link direto (ZIP):**

https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/download/v1.7.28/SinapescREAP-Windows-v1.7.28.zip

Página da release: https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/tag/v1.7.28

Versão anterior: [v1.7.27](https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/tag/v1.7.27)
