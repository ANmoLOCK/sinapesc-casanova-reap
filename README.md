...
| Versão atual | [**v1.7.41**](https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/tag/v1.7.41) |
...
## Download do EXE (v1.7.41)

**Link direto (ZIP):**

https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/download/v1.7.41/SinapescREAP-Windows-v1.7.41.zip

Página da release: https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/tag/v1.7.41

Versão anterior: [v1.7.40](https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/tag/v1.7.40)
