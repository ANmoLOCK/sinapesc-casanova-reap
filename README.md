...
| Versão atual | [**v1.7.47**](https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/tag/v1.7.47) |
...
## Download do EXE (v1.7.47)

**Link direto (ZIP):**

https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/download/v1.7.47/SinapescREAP-Windows-v1.7.47.zip

Página da release: https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/tag/v1.7.47

Versão anterior: [v1.7.46](https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/tag/v1.7.46)
