...
| Versão atual | [**v1.7.16**](https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/tag/v1.7.16) |
...
## Download do EXE (v1.7.16)

**Link direto (ZIP):**

https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/download/v1.7.16/SinapescREAP-Windows-v1.7.16.zip

Página da release: https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/tag/v1.7.16

Versão anterior: [v1.7.15](https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/tag/v1.7.15)
