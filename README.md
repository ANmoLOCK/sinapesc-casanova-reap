...
| Versão atual | [**v1.7.11**](https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/tag/v1.7.11) |
...
## Download do EXE (v1.7.11)

**Link direto (ZIP):**

https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/download/v1.7.11/SinapescREAP-Windows-v1.7.11.zip

Página da release: https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/tag/v1.7.11

Versão anterior: [v1.7.10](https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/tag/v1.7.10) · [v1.7.9](https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/tag/v1.7.9)
