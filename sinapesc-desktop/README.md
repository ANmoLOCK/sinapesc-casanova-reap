...
**v1.7.28** — Modal Cadastrar sócio sólido e organizado (sem transparência).
...
**Download pronto:** [SinapescREAP-Windows-v1.7.28.zip](https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/download/v1.7.28/SinapescREAP-Windows-v1.7.28.zip)
