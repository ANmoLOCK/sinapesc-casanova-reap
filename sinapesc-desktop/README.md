...
**v1.7.31** — Corrige consulta MPA (polling + gravação da situação).
...
**Download pronto:** [SinapescREAP-Windows-v1.7.31.zip](https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/download/v1.7.31/SinapescREAP-Windows-v1.7.31.zip)
