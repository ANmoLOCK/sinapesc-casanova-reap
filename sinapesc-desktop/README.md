...
**v1.7.29** — Consulta RGP tela cheia fiel ao mockup (proporções e respiro).
...
**Download pronto:** [SinapescREAP-Windows-v1.7.29.zip](https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/download/v1.7.29/SinapescREAP-Windows-v1.7.29.zip)
