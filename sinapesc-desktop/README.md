...
**v1.7.27** — Consulta RGP: UI conforme opções (chips, painel sem abas, cadastro + MPA auto).
...
**Download pronto:** [SinapescREAP-Windows-v1.7.27.zip](https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/download/v1.7.27/SinapescREAP-Windows-v1.7.27.zip)
