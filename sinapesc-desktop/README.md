...
**v1.7.30** — Consulta MPA grava situação RGP + UI menos apertada.
...
**Download pronto:** [SinapescREAP-Windows-v1.7.30.zip](https://github.com/ANmoLOCK/sinapesc-casanova-reap/releases/download/v1.7.30/SinapescREAP-Windows-v1.7.30.zip)
